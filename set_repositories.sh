...
#hack the new installation due to the missing package of tor-hs-patch-config in "deb.ln-ask.me/beta bullseye" until it is resolved. Get it from the "deb.ln-ask.me/beta buster".
#if [[ "$codename" = "bullseye" ]]; then
#  echo "deb [signed-by=3D9E81D3CA76CDCBE768C4B4DC6B4F8E60B8CF4C] https://deb.ln-ask.me/beta buster common local desktop" | tee -a /etc/apt/sources.list.d/cryptoanarchy.list > /dev/null
#fi
