...
#hack the new installation due to missing package of tor-hs-patch-config in "deb.ln-ask.me/beta bullseye" until it is resolved. Get it from the "deb.ln-ask.me/beta buster".
